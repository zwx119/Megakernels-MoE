...
// Warp 分配常量
// ============================================================================
// warp 0~7:  attention consumer（8 个 warp 并行处理 8 个 Q head partition）
// warp 8~15: MoE consumer（8 个 warp 协作，RED_DIM=256，但内部拆成 2×128 累加）
// 两组 warp 并发执行，构成 attention ↔ MoE 跨 instruction 流水线
